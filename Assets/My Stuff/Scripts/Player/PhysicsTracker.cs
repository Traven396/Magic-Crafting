namespace FoxheadDev.GestureDetection
{
	...
	//This is not a system that I created fully, but I have augmented it a lot to be specifically for gestures
	//The OG source is from https://github.com/Unity-Technologies/SuperScience/tree/main/Runtime/PhysicsTracker
	//They have a ton of good stuff for VR besides this as well.
	public class PhysicsTracker
	{
		public Transform TrackedTransform { get; private set; }
		public Transform MainBodyTransform { get; private set; }

        #region Constructors + Setters
        public PhysicsTracker(Transform tracked, Transform mainBody)
        {
            TrackedTransform = tracked;

            MainBodyTransform = mainBody;
        }
        #endregion
        #region Constants
        /// <summary>
        ...
        Vector3 m_LastBodyOffsetPosition = Vector3.zero;
        Vector3 m_LastDirectionPosition = Vector3.zero;
        Quaternion m_LastRotation = Quaternion.identity;
		#endregion
		#region Output
		// Output data
        //This is the direction out of the palm. This way it will work either hand its used on. You can call the same property without having to check yourself.
        ...
        //Essentially the magnitude of the AngularVelocity
        public float AngularSpeed { get; private set; }
        //The axis we are rotating around
        public Vector3 AngularAxis { get; private set; }
        public Vector3 AngularVelocity { get; private set; }
        //This is the velocity of the tips of the fingers. This is used for detecting flicking.
        public Vector3 SelfSpaceAngularVelocity { get => TrackedTransform.InverseTransformDirection(AngularVelocity); }
        public Vector3 ViewSpaceAngularVelocity { get => Camera.main.transform.InverseTransformDirection(AngularVelocity); }
        public float AngularAccelerationStrength { get; private set; } // This value can be negative, for deceleration
        public Vector3 AngularAcceleration { get; private set; } 
        #endregion

        //This method should be called when the trackers are initialized
        /// <summary>
		...
		{
            #region Linear + Angular Velocities
            ...
            var currentOffset = (newPosition - m_LastOffsetPosition) - (MainBodyTransform.position - m_LastBodyOffsetPosition);
            var currentDistance = currentOffset.magnitude;

            m_LastBodyOffsetPosition = MainBodyTransform.position;
